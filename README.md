...
## URL
 http://myspot.site （ゲストログインですぐにお試しいただけます）

## インフラ構成図
<img width="1294" alt="スクリーンショット 2021-03-04 22 48 14" src="https://user-images.githubusercontent.com/73152774/109973462-c2392700-7d3b-11eb-9de6-8958afc73a5e.png">
...
## 工夫したポイント
行きたい場所の探しやすさを追求するため、検索機能とお気に入り登録機能を実装しました。
検索機能：ほとんどのユーザーは、場所から検索をすると考え、プルダウンで都道府県を選択し、場所を限定した上で検索できるように工夫しました。
お気に入り登録機能：検索結果の中からスポットを選ぶ基準が必要と考え、お気に入り登録機能を実装しました。各投稿にお気に入り登録数を表示させることで投稿の人気度を確認でき、ユーザーがスポットを選ぶ際に参考にすることができます。

![検索機能](https://user-images.githubusercontent.com/73152774/110059431-8f2c7d00-7da7-11eb-9bd8-2f3ab8e8b571.gif)

![お気に入り](https://user-images.githubusercontent.com/73152774/110059393-7e7c0700-7da7-11eb-9a1d-ad55eb24ab05.gif)
...
### AWS
     EC2, ECR, ECS, RDS, S3, Route53, IAM
### データベース
     MySQL
### Webサーバー
     Nginx
